...
public:
	...
	, m_noResize(true)
	{
		...
		QFont font(qFromUtf8Stl(Settings::LunaSettings()->fontQuicklaunch), 18 * Settings::LunaSettings()->layoutScale);
		font.setPixelSize(18 * Settings::LunaSettings()->layoutScale);
		font.setStyle(QFont::StyleOblique);
		QString title = qFromUtf8Stl(LOCALIZED("Just type..."));

		QRect textBounds(0, 0, m_boundingRect.width(), m_boundingRect.height());
		textBounds.adjust(20 * Settings::LunaSettings()->layoutScale,0,-45 * Settings::LunaSettings()->layoutScale,0);
