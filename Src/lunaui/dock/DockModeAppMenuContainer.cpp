...
static int kMenuItemHeight = 70 * Settings::LunaSettings()->uiScale;
...
DockModeMenuItem::DockModeMenuItem (DockModeLaunchPoint* dlp, DockModeAppMenuContainer* parent)
	: m_dockLp (dlp), m_parent (parent), m_padding (10 * Settings::LunaSettings()->uiScale), m_pressed (false), m_iconSize (48 * Settings::LunaSettings()->uiScale), m_isLast (true)
{
...
void DockModeMenuItem::paint (QPainter* painter, const QStyleOptionGraphicsItem* option, QWidget* widget)
{
	...
	newFont.setPixelSize (18 * Settings::LunaSettings()->uiScale);
	...
	: m_menuHeight (0.0), m_penDown (false), m_currentItemIndex (-1), m_maxHeight (0)
{
	...
	m_font = QFont (fontName, 21 * Settings::LunaSettings()->uiScale);
	m_font.setBold(true);
