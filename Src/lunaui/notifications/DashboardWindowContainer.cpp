...
void DashboardWindowContainer::initPixmaps()
{
	if(!m_isMenu) {
		...
		if(NULL == m_tabletTopMask) {
			...
			*m_tabletTopMask = m_tabletTopMask->scaledToHeight(m_tabletTopMask->height() * Settings::LunaSettings()->uiScale, Qt::SmoothTransformation);
		}
		...
		if(NULL == m_tabletbottomMask) {
			...
			*m_tabletbottomMask = m_tabletbottomMask->scaledToHeight(m_tabletbottomMask->height() * Settings::LunaSettings()->uiScale, Qt::SmoothTransformation);
		}
		...
		if(NULL == m_tabletTopMask) {
			...
			*m_tabletBackground = m_tabletBackground->scaledToHeight(m_tabletBackground->height() * Settings::LunaSettings()->uiScale, Qt::SmoothTransformation);
		}
		...
		if(NULL == m_tabletArrowUp) {
			...
			*m_tabletArrowUp = m_tabletArrowUp->scaledToHeight(m_tabletArrowUp->height() * Settings::LunaSettings()->uiScale, Qt::SmoothTransformation);
		}
		...
		if(NULL == m_tabletArrowDown) {
			...
			*m_tabletArrowDown = m_tabletArrowDown->scaledToHeight(m_tabletArrowDown->height() * Settings::LunaSettings()->uiScale, Qt::SmoothTransformation);
		}
		...
		if(NULL == m_menuSwipeBkg) {
			...
			*m_menuSwipeBkg = m_menuSwipeBkg->scaledToHeight(m_menuSwipeBkg->height() * Settings::LunaSettings()->uiScale, Qt::SmoothTransformation);
		}
		...
		if(NULL == m_menuSwipeHighlight) {
			...
			*m_menuSwipeHighlight = m_menuSwipeHighlight->scaledToHeight(m_menuSwipeHighlight->height() * Settings::LunaSettings()->uiScale, Qt::SmoothTransformation);
		}
		...
		if(NULL == m_itemSeparator) {
			...
			*m_itemSeparator = m_itemSeparator->scaledToHeight(m_itemSeparator->height() * Settings::LunaSettings()->uiScale, Qt::SmoothTransformation);
		}
